...
%% Inciso d)
% Se genera una señal sinusoidal muestreada a 1024 Hz, durante un segundo, 
% cuya frecuencia aumenta linealmente desde 0 a 500 Hz durante su duración. 
% La amplitud de la señal decae linealmente desde 1 a 0 en el lapso de 
% tiempo.
...
%% Inciso e)
% Al ver el espectro de magnitud de esta señal, podemos apreciar que se
...
% forma en que se generó la señal, dado que a medida que la frecuencia
...
% señal a medida que pasa el tiempo.

figure()
subplot(3,1,1),plot(t,y);
title('Señal senoidal'); xlabel('Tiempo [s]');
grid on; axis tight;
