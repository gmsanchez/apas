...
%% Inciso a) Escriba una función que permita calcular la descomposición 
% Paquetes de Onditas completa (es decir sobre el árbol completo), iterando 
% con la función dstep tanto sobre los coeficientes de aproximación como en 
...
%% Inciso b) Escriba una una función wpdec que permita ingresar la 
...
%% Inciso c) Escriba una función wprec que reconstruya mediante la 
% iteración de la función rstep, una señal, dada su descomposición generada 
% con wpdec y la estructura del árbol.

dbtype my_wprec

%% Inciso d) Utilice esta descomposición y reconstrucción sobre una señal 
% cualquiera. Grafique la señal original, la reconstruida y el error de 
