...
% x perteneciente a R^N a partir de un diccionario $\Phi$ R^(N×M) dado y un 
...
% la función utilizando vectores a cuyos elementos distintos de cero sean 
% iid con distribución uniforme en el rango [-2, -1] U [1, 2].
clear all
close all
