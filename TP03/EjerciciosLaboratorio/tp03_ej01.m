...
% Compute the local Fourier transform around a point t0 of x, which is the
% FFT (use the function fft) of the windowed signal x.*h where h is smooth 
% windowing function located around t0. For instance you can use for h a 
% Gaussian bump centered at t0. To center the FFT for display, use fftshift.
...
% A denoising is performed by hard or 
